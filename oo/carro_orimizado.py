...
O     L
   S
    ...
    >>> # Testando a composição do Carro
...
class Direcao:
    ...
    # Como a representação da direção ocorreu com varios if e elif, essa estrutura remete a um dicionário
    # indicando uma chave e retornando com o valor conforme a diração para giro solicitada.
    def girar_a_direita(self):
